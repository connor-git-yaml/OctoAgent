...
class TestFR010aIntegration:
    """FR-010a: irreversible 安全保障集成测试"""

    async def test_irreversible_rejected_without_checkpoint(self, mock_event_store) -> None:
        """无 PolicyCheckpoint 时，irreversible 工具被拒绝"""
