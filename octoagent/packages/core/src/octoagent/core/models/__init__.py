...
# F099 Phase C: source_kinds 常量模块 re-export
# 提供两套常量：SOURCE_RUNTIME_KIND_*（caller 身份枚举）和 CONTROL_METADATA_SOURCE_*（事件来源操作）
