...
class SqliteWorkStore:
    ...
    async def save_work(self, work: Work) -> Work:
        await self._conn.execute(
            ...
            INSERT INTO works (
                ...
                turn_executor_kind, agent_profile_id, requested_agent_profile_id,
                requested_agent_profile_version, effective_profile_snapshot_id,
            ...
            ON CONFLICT(work_id) DO UPDATE SET
                ...
                requested_agent_profile_id = excluded.requested_agent_profile_id,
                requested_agent_profile_version = excluded.requested_agent_profile_version,
                effective_profile_snapshot_id = excluded.effective_profile_snapshot_id,
            ...
            (
                ...
                work.requested_agent_profile_id,
                work.requested_agent_profile_version,
                work.effective_profile_snapshot_id,
    ...
    def _row_to_work(row: aiosqlite.Row) -> Work:
        return Work(
            ...
            requested_agent_profile_id=row["requested_agent_profile_id"],
            requested_agent_profile_version=row["requested_agent_profile_version"],
            effective_profile_snapshot_id=row["effective_profile_snapshot_id"],
