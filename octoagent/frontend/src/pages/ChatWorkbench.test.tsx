    ...
    snapshot.resources.delegation.works = [
      {
        ...
        requested_agent_profile_id: "project-default:ops-root",
        requested_agent_profile_version: 1,
        effective_profile_snapshot_id: "worker-snapshot:ops-root:1",
        child_work_ids: [],
        child_work_count: 0,
        merge_ready: false,
        runtime_summary: {},
    ...
    snapshot.resources.delegation.works = [
      {
        ...
        project_id: "project-default",
        workspace_id: "workspace-default",
        requested_agent_profile_id: "worker-profile-project-default-default-project-agent",
        requested_agent_profile_version: 1,
        effective_profile_snapshot_id: "worker-snapshot:general:1",
        child_work_ids: [],
        child_work_count: 0,
        merge_ready: false,
        runtime_summary: {},
