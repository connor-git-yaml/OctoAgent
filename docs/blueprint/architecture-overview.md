...
7. 当前 branch 已通过 iPhoneOS target build、focused Gateway regression 与
   source/bundle secret scan；Simulator、真机与 Cloudflare live 证据仍是 F153
   Verify 硬门，不能由编译或静态扫描替代。
