...
- **向开发者要决策时产品化、别陷在细节**：需要我（开发者）拍板时，把问题和选项讲得产品化、通俗些——别一头扎进实现细节，而是从产品/用户视角说清这个选择影响了用户什么（功能、体验、风险或代价），并给足背景。不要假定我已经看过你提到的代码和文档，判断需要的关键信息直接写进来。原因：陷在技术细节里的提问让人抓不住重点、难权衡，等于把决策成本甩回给我。例外：问题确实复杂到几句话讲不清时，先给一句话结论 + 推荐项，再附"想深入可看 X"的指引
