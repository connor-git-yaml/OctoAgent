...
# Function to get highest number from feature directory
...
check_existing_branches() {
    ...
    # Get highest number from ALL feature directories (not just matching short name)
    local highest_spec=$(get_highest_from_features "$features_dir")
