...
| R17 | architecture/clean-wheel checker内部规模 | F150 T004把staged new-module authority改为“当前public API是最终批准集合的非空子集、imports/private helper可存在”，避免未来symbol空壳；T005把forbidden token检查收敛为相对base的新增计数，避免把已冻结baseline字符串误判为本slice新增，同时继续拒绝任何净新增；T006把Data Model已冻结的`CloudflarePrincipal`名称同步到allowlist/fixture，不增加第二身份实体。runtime checker冻结SHA=`de0abce847f2e4ce690cc1e9fef6614c255fd6897f2e21fca3fc613b746e8d82`/4955 LOC/209 funcs/max48/McCabe≤10/职责簇8/single parser+runner。当前clean-wheel checker冻结SHA=`68f75a1c4bb38260b868c1b89b354467f5d753aa052851428cf3361aadf73cea`/2176 LOC/111 funcs/max43/McCabe≤10 | 两者各保持single parser+runner/module；无broad exception、mutable global、测试路径识别或duplicate body。F150 authority只按base ref、production path与AST/export事实判断；后续增长/新职责须重新review，不机械压缩 |
