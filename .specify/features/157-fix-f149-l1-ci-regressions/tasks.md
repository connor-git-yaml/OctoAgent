...
- [x] T003 为安全 model-call SSE projection 添加 Gateway RED 合同
- [x] T004 为 Web decoder / TaskDetail 边界添加 RED 合同
- [x] T005 实现单一有限 model-call projection
- [x] T006 修正 A-wave fixture 的过期时间语义
- [x] T007 修正 390px 空状态无障碍断言
