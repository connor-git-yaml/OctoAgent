...
> 当前只完成 Research/Decision dossier。用户未明确接受系统 full access 前，
> Design/Tasks Gate 均为 false；下列实现任务不得执行。

- [x] **T000 [RESEARCH]** Apple 官方权限事实、产品方案、Data Model、Threat Model、
  Contract 与 decision dossier
- [ ] **T001 [PRODUCT DECISION]** 用户明确选择保留或移除 F155；记录 exact 决定
- [ ] **T002 [GATE]** 复审并批准 Spec/Plan/Tasks/authority inventory
